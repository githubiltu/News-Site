  ...
  switch($page){
    case "single.php":
      if(isset($_GET['id'])){
        ...
        $result_title = mysqli_query($conn, $sql_title) or die("Title Query Failed: " . mysqli_error($conn));
    ...
    default:
      ...
      $result_title = mysqli_query($conn, $sql_title) or die("Title Query Failed: " . mysqli_error($conn)); // Added MySQL error
      if ($result_title) {
          $row_title = mysqli_fetch_assoc($result_title);
          $page_title = $row_title['websitename'];
      } else {
          die("Fetch Query Failed: " . mysqli_error($conn)); // Added MySQL error for fetch failure
      }
      break;
  }
?>
