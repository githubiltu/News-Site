      ...
      <div class="col-md-8">
        ...
        <div class="post-container">
          <?php
            ...
            // Check if 'cid' is set and assign it to $cat_id
            if(isset($_GET['cid'])){
                $cat_id = $_GET['cid'];
                ...
                echo "<h2 class='page-heading'>{$category_name}</h2>";
                  ...
                  <div class="inner-content clearfix">
                    ...
                    <div class="post-information">
                      <span>
                        ...
                        <a href='category.php?cid=<?php echo $cat_id; ?>'><?php echo $row['category_name']; ?></a>
                      </span>
                      <span>
            ...
            <?php
                ...
                // Pagination Query
                $sql1 = "SELECT COUNT(post_id) AS total_posts FROM post WHERE category = {$cat_id}";
                $result1 = mysqli_query($conn, $sql1) or die("Query failed.");
                $row = mysqli_fetch_assoc($result1);
                $total_records = $row['total_posts'];
                ...
                echo "<h2>Category ID not specified.</h2>";
            }
          ?>
        </div><!-- /post-container -->
      </div>
